...
2. a) `notebooks/02a_create_paper_assessment_annotations.ipynb`:
...
2. b) `notebooks/02b_evaluate_paper_assessment_prompt.ipynb`:
...
2. c) `notebooks/02c_generate_paper_assessment_predictions.ipynb`: 
...
3. a) `notebooks/03a_create_repo_assessment_annotations.ipynb`:
...
3. b) `notebooks/03b_evaluate_repo_assessment_prompt.ipynb`:
...
3. c) `notebooks/03c_download_repos.ipynb`: 
...
3. d) `notebooks/03d_generate_repo_assessment_predictions.ipynb`:
